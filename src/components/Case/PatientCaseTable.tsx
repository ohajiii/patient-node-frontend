...
export default function PatientCaseTable(props: { cases: CaseResponseDto[] }) {
      ...
      <table className="w-full bg-white shadow rounded-lg border border-gray-200">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="text-left p-3 border-b font-medium text-gray-700">Created</th>
